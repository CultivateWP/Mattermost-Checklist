...
ifeq ($(PLUGIN_ID),com.billerickson.mattermost-checklist)
	$(warning WARNING)
	$(warning You are building with the example plugin ID "com.billerickson.mattermost-checklist".)
...
ifneq ($(HAS_SERVER),)
	...
	@echo No mock generation targets are configured for this plugin.
endif
